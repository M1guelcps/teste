...
# Meta tag para AdSense (opcional no contexto do Streamlit, mas incluída por consistência)
components.html("""
    <meta name="google-adsense-account" content="ca-pub-4010266302231674">
""", height=0)
...
if submitted:
    ...
    if subscription == "Gratuito":
        st.markdown("---")
        components.html("""
            <script async src='https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4010266302231674' crossorigin='anonymous'></script>
            <ins class='adsbygoogle'
                style='display:block; text-align:center;'
                data-ad-client='ca-pub-4010266302231674'
